...
$pf = bodycondition::byId($id);
$r=$pf->save($insert);	



   $message    =   new Message('Record edited successfully','message');
      $message->setMessage();
...
?>
        ...
        ?>
				...
				<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="editbodycondition.php?id=<?php echo $_GET['id']; ?>">
				...
				<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>"/>								
						...
						<div class="col-xs-4">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="form-field-1" placeholder="Template name"  name="txtpagename"  value="<?php echo $res['name']; ?>"  class="col-xs-12 col-sm-12" />
									</div>
								</div>
