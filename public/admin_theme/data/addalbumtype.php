...
<?php include("sidemenu.php"); ?>
			...
			<script type="text/javascript">
function loadstate(cntry){

	// showFields("searchcity.php?optcountry="+cntry, "cityLyr");
	$('#optstate').load("../searchaddstate.php?optcountry="+cntry);
}
...
if($name==''){
  ...
  $insert=array('name'=>$name,'status'=>$status);
  
$obj = new bodycondition($insert);
$lastid=$obj->save();  	  	


   $message    =   new Message('Record added successfully','message');
      $message->setMessage();
...
?>
		...
		<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="addbodycondition.php">
						...
						<div class="col-xs-4">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="form-field-1" placeholder="Name" name="txtpagename"  value="<?php echo $_POST['txtpagename']; ?>" class="col-xs-12 col-sm-12" />
									</div>
								</div>
