...
<?php echo $sidemenu; ?>
   ...
   <script type="text/javascript">  
       ...
       <script type="text/javascript">  
		...
		<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>/auth/cms/edit/<?php echo $id; ?>">

			<div class="col-xs-12 col-sm-12 widget-container-col">
									<!-- #section:custom/widget-box -->
									<div class="widget-box">
										<div class="widget-header">
											<h5 class="widget-title">CMS Details</h5>
	...
	<?php echo form_hidden($csrf); ?>
						...
						<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="form-field-1" placeholder="Page Name"  name="txtMenuTitle" value="<?php echo $record["title"];?>"  class="col-xs-12 col-sm-12" />
									</div>
								</div>
...
<img src="<?php echo base_url(); ?>/uploads/<?php echo $record['banner'];?>" width="150px" height="150px" alt="" >
									</div>
								</div>
...
<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<option value="0" <?php if($record["title"]==0){?> selected="selected"<?php }?>>-------Top-------</option>
                            <?php
                            ...
                            foreach($parentList as $ind=>$val){   //loop 1 start
                                ...
                                ?>
                                <option value="<?php echo $val["id"]?>" <?php if($record["title"]==$val["id"]){?> selected="selected"<?php }?>><?php echo $val["title"]?>
                                </option>                               
                                <?php
                                 if($sub!=''){
                                if(count($sub)>0){ //if1
                            	...
                            	$subb='';
                                            ...
                                            ?>
                                            <option value="<?php echo $vall["id"]?>" <?php if($record["title"]==$vall["id"]){?> selected="selected"<?php }?> ><?php echo $vall['title'];?></option>
                                            <?php
                                              if($subb!=''){
                                            if(count($subb)>0)  {
                                                foreach($subb as $inddd=>$valll){
                                                    ?>
                                                     <option value="<?php echo $valll["id"]?>" <?php if($record["title"]==$valll["id"]){?> selected="selected"<?php }?> > &nbsp;&nbsp;&nbsp;--<?php echo $valll['title'];?></option>
                                                    <?php
                                                }
                                            } }
			...
			<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="form-field-1" placeholder="Page Title" name="txtTitle"  value="<?php echo $record["page_title"];?>"  class="col-xs-12 col-sm-12" />
									</div>
								</div>
...
<div class="row">
      		...
      		<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<textarea name="txtContent" id="description" rows="5" cols="80"><?php echo $record["content"];?></textarea>
									</div>
								</div>
...
<?php
$titlecount=strlen($record['seo_title']);
$remainingtitlecount=70-$titlecount;


$desccount=strlen($record['seo_description']);
$remainingdesccount=160-$desccount;
?>
	...
	<div class="row">
			<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
									<input type="text" name="seo_title" id="seo_title" onkeyup="countseotitle()" class="form-control" maxlength="70" value="<?php echo $record['seo_title']; ?>">
									</div>
									<label class="col-sm-3" for="form-field-1" style="color:red;"> Remaining Characters: <span id="seo_title_label"><?php echo $remainingtitlecount; ?> </span> </label>
								</div>
...
<div class="row">
       	<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
											<textarea id="form-field-tags"   name="seo_keywords" class="autosize-transition form-control"><?php echo $record['seo_keywords']; ?></textarea>
								</div>
								</div></div>
<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
									<input type="text" name="seo_slug" class="form-control" maxlength="70" value="<?php echo $record['seo_slug']; ?>">
									</div>
...
<div class="row">
     		...
     		<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
								<textarea id="seo_description" onkeyup="countseodescription()"  maxlength="160" name="seo_description" class="autosize-transition form-control"><?php echo $record['seo_description']; ?></textarea>

									</div>
									<label class="col-sm-3" for="form-field-1" style="color:red;"> Remaining Characters: <span id="seo_description_label"><?php echo $remainingdesccount; ?></span> </label>
								</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				try{
					...
					tag_input.after('<textarea  class="autosize-transition form-control" id="'+tag_input.attr('id')+'" name="'+tag_input.attr('name')+'" >'+tag_input.val()+'</textarea>').remove();
