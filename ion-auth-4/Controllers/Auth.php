...
class Auth extends \CodeIgniter\Controller
{
    ...
    protected $viewsFolder1 = 'Admin\Views\admin_theme';
	/**
	 * Constructor
	 *
	 * @return void
	...
	public function login()
	{
     ...
     echo view('Admin\Views\admin_template\login_header', $this->data);
     echo view('IonAuth\Views\auth\login', $this->data);
    echo view('Admin\Views\admin_template\login_footer', $this->data);
     // return $this->renderPage($this->viewsFolder1 . DIRECTORY_SEPARATOR . 'login_header', $this->data);
     // return $this->renderPage($this->viewsFolder . DIRECTORY_SEPARATOR . 'login', $this->data);
     // return $this->renderPage($this->viewsFolder1 . DIRECTORY_SEPARATOR . 'login_footer', $this->data);
